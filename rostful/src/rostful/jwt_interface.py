...
class JwtInterface:
    ...
    def encode(self, payload):
        ...
        try:
            ...
            rospy.logerr('JwtInterface::encode: %s. payload %s',
                         e, str(payload))
    ...
    def decode(self, msg):
        ...
        try:
            ...
            rospy.logerr('JwtInterface::decode:InvalidTokenError: %s. key = %s, algorithm = %s, msg = %s',
                         e, self.key, self.algorithm, msg)
        except jwt.exceptions.DecodeError as e:
            rospy.logerr('JwtInterface::decode:DecodeError: %s. key = %s, algorithm = %s, msg = %s',
                         e, self.key, self.algorithm, msg)
        except TypeError as e:
            rospy.logerr('JwtInterface::decode:TypeError: %s. key = %s, algorithm = %s, msg = %s',
                         e, self.key, self.algorithm, msg)
